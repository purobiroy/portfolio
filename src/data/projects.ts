...
export const projects: Project[] = [
  {
    ...
    challenge: "Create a simple, patient-friendly website for fetal healthcare where users may not understand medical terms. The doctor also lacked an individual online presence, and this was my first website project.",
    solution: "To address these challenges, I built a fully functional, website using WordPress, with domain and hosting set up via Hostinger. The website was designed with simplicity and clarity at its core, ensuring that all content was written in easy-to-understand, non-technical language tailored to a patient’s perspective. The structure included essential pages such as About, Services, and Blogs, allowing users to easily navigate and find relevant information. Special attention was given to presenting healthcare services in a way that improved awareness and accessibility for a wider audience. To enhance user engagement and conversions, strong call-to-action elements were integrated, including WhatsApp chat, direct messaging, and a ‘Book Appointment’ feature—making it seamless for patients to connect with the practitioner. Additionally, basic on-page SEO practices such as optimized meta tags, keyword-friendly content, and structured pages were implemented to improve search visibility and help patients discover the services more easily."
  },
  {
    id: "facebook-ads",
